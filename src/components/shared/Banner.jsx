...
export default function Banner() {
  return (
    <div className="bg-[linear-gradient(rgba(49,84,44,0.2),rgba(16,71,52,0.7)),url('https://images.unsplash.com/photo-1600565193348-f74bd3c7ccdf?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y2hlZnxlbnwwfDB8MHx8fDA%3D')] h-[600px] w-[1320px] bg-no-repeat bg-cover rounded-lg">
